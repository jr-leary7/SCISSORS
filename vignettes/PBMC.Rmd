...
```{r}
p9 <- FeaturePlot(pbmc, features = "CD14") + 
      scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) + 
      theme_yehlab() + 
      NoLegend() + 
      theme(axis.title = element_blank())
p10 <- FeaturePlot(pbmc, features = "LYZ") + 
       scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) + 
       theme_yehlab() + 
       NoLegend() + 
       theme(axis.title = element_blank())
...
```{r}
p11 <- FeaturePlot(pbmc, features = "FCGR3A") + 
       scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) + 
       theme_yehlab() + 
       NoLegend() + 
       theme(axis.title = element_blank())
p12 <- FeaturePlot(pbmc, features = "MS4A7") + 
       scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) + 
       theme_yehlab() + 
       NoLegend() + 
       theme(axis.title = element_blank())
...
```{r}
p13 <- FeaturePlot(pbmc, features = "HLA-DPB1") + 
       scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) + 
       theme_yehlab() + 
       NoLegend() + 
       theme(axis.title = element_blank())
p14 <- FeaturePlot(pbmc, features = "CD74") + 
       scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) + 
       theme_yehlab() + 
       NoLegend() + 
       theme(axis.title = element_blank())
p15 <- FeaturePlot(pbmc, features = "HLA-DRA") + 
       scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) + 
       theme_yehlab() + 
       NoLegend() + 
       theme(axis.title = element_blank())
...
```{r}
p16 <- FeaturePlot(pbmc, features = "MS4A1") + 
       scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) + 
       theme_yehlab() + 
       NoLegend() + 
       theme(axis.title = element_blank())
...
```{r}
p17 <- FeaturePlot(pbmc, features = "CD8A") + 
       scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) + 
       theme_yehlab() + 
       NoLegend() + 
       theme(axis.title = element_blank())
...
```{r}
p18 <- FeaturePlot(pbmc, features = "NKG7") + 
       scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) + 
       theme_yehlab() + 
       NoLegend() + 
       theme(axis.title = element_blank())
p19 <- FeaturePlot(pbmc, features = "GNLY") + 
       scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) + 
       theme_yehlab() + 
       NoLegend() + 
       theme(axis.title = element_blank())
...
```{r}
p20 <- FeaturePlot(pbmc, features = "FCER1A") + 
       scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) + 
       theme_yehlab() + 
       NoLegend() + 
       theme(axis.title = element_blank())
p21 <- FeaturePlot(pbmc, features = "CST3") + 
       scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) + 
       theme_yehlab() + 
       NoLegend() + 
       theme(axis.title = element_blank())
...
```{r}
p22 <- FeaturePlot(pbmc, features = "PPBP") + 
       scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) + 
       theme_yehlab() + 
       NoLegend() + 
       theme(axis.title = element_blank())
...
pbmc$label <- as.factor(pbmc$label)
Idents(pbmc) <- "label"
```
...
```{r}
p23 <- DimPlot(pbmc, cols = paletteer_d("ggthemes::Classic_10")) + 
       theme_yehlab() + 
...
p24 <- DotPlot(pbmc, features = unique(top_de_final$gene)) + 
       scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) +
       labs(color = "Scaled Mean Expression", size = "% Expressed", x = "Marker Genes") + 
...
```{r}
SaveFigure <- function(my.plot = NULL, name = NULL) {
...
```{r}
SaveFigure(p0, names = "Seurat_Clusters")
SaveFigure(p1, names = "Seurat_Clusters_FitSNE")
SaveFigure(p2, names = "Marker_Genes_For_Seurat_Clusters")
SaveFigure(p3, names = "Monocyte_Cluster_SCISSORS")
SaveFigure(p4, names = "T_Cluster_SCISSORS")
SaveFigure(p5, names = "SCISSORS_Clusters_Final")
SaveFigure(p6, names = "CD4T_IL7R")
SaveFigure(p7, names = "CD4T_CCR7")
SaveFigure(p8, names = "CD4T_S100A4")
SaveFigure(p9, names = "Monocyte_CD14")
SaveFigure(p10, names = "Monocyte_LYZ")
SaveFigure(p11, names = "FCGR3A_Monocyte_FCGR3A")
SaveFigure(p12, names = "FCGR3A_Monocyte_MS4A7")
SaveFigure(p13, names = "Intermediate_Mono_HLADPB1")
SaveFigure(p14, names = "Intermediate_Mono_CD74")
SaveFigure(p15, names = "Intermediate_Mono_HLADRA")
SaveFigure(p16, names = "B_MS4A1")
SaveFigure(p17, names = "CD8T_CD8A")
SaveFigure(p18, names = "NK_NKG7")
SaveFigure(p19, names = "NK_GNLY")
SaveFigure(p20, names = "DC_FCER1A")
SaveFigure(p21, names = "DC_CST3")
SaveFigure(p22, names = "Platelet_PPBP")
SaveFigure(p23, names = "SCISSORS_Celltypes_Final")
SaveFigure(p24, names = "Marker_Genes_For_SCISSORS_Celltypes")
```
