...
p26 <- DotPlot(mono_only, features = unique(top5_mono_markers$gene), dot.scale = 15) + 
       scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) +
       labs(color = "Expression", size = "% Expressed", y = NULL) + 
       theme(axis.text.x = element_text(angle = 90, size = 16, vjust = 0.5), 
             legend.position = "right", 
...
SaveFigure(p2a, name = "Marker_Genes_For_Seurat_Clusters", height = 8, width = 18)
SaveFigure(p2b, name = "Marker_Genes_For_Seurat_Clusters_Specific", height = 8, width = 18)
...
SaveFigure(p26, name = "Monocyte_Cluster_SCISSORS_Dotplot_Specific", height = 5, width = 8)
SaveFigure(p27, name = "T_Cluster_SCISSORS_Dotplot_Specific", height = 5, width = 8)
```
