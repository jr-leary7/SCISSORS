...
We see that our method gives the highest median silhouette score over the `Seurat` vignette's results, `GiniClust3`, and `SAFE`. 

```{r}
ggplot(clust_sils, aes(x = Method, y = Silhouette, fill = Method)) + 
  geom_violin(draw_quantiles = 0.5) +
  geom_signif(test = wilcox.test, map_signif_level = TRUE, step_increase = .1, 
              comparisons = list(c("SCISSORS", "GiniClust3"), c("SCISSORS", "Seurat"), c("SCISSORS", "SAFE"))) + 
