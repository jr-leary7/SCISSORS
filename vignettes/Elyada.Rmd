...
We run the typical single cell pre-processing steps on our cells - normalization, dimension reduction, and clustering. The t-SNE embedding looks OK, but could definitely be improved. Globally, the clusters are arranged in a blob, though the local structure seems to have been preserved fairly well. Cluster 4 is split in two, which we would prefer not to have happen. 
