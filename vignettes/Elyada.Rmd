...
Let's check out the t-SNE embedding. It looks decent, but could definitely be improved. Globally, the clusters are arranged in a blob - which isn't very informative - though the local structure seems to have been preserved fairly well. 
...
p23 <- DimPlot(fibro, reduction = "tsne", group.by = "label", pt.size = 1.5) + 
       scale_color_manual(values = paletteer_d("ggsci::default_nejm")) + 
       labs(x = "Fit-SNE 1", y = "Fit-SNE 2") + 
       theme_yehlab() + 
       theme(plot.title = element_blank())
...
DimPlot(nkt_tumor, reduction = "tsne")
FeaturePlot(nkt_tumor, reduction = "tsne", features = "")
```
...
p40 <- DimPlot(nkt_tumor, reduction = "tsne", group.by = "label", pt.size = 1.5) + 
       scale_color_manual(values = paletteer_d("ggsci::default_nejm")) + 
       labs(x = "Fit-SNE 1", y = "Fit-SNE 2") + 
       theme_yehlab() + 
       theme(plot.title = element_blank()) + 
...
p51 <- DimPlot(nkt_norm, reduction = "tsne", group.by = "label", pt.size = 1.5) + 
       scale_color_manual(values = paletteer_d("ggsci::default_nejm")) + 
       labs(x = "Fit-SNE 1", y = "Fit-SNE 2") + 
       theme_yehlab() + 
       theme(plot.title = element_blank()) + 
...
ductal <- ReclusterCells(pdac, 
                         ...
                         redo.embedding = TRUE, 
                         random.seed = 629)
DimPlot(ductal, reduction = "tsne")
# cluster 2 = acinar
# cluster 5 = lipid proc
# cluster 3 = secretory 
# cluster 6 = classic 2
# cluster 0 & 1 & 4 = classic 1

FeaturePlot(ductal, reduction = "tsne", features = "CTRB2")
```
...
We use ANPEP expression to identify the lipid processing ductal cells in cluster 6. 
...
p64 <- DimPlot(ductal, reduction = "tsne", group.by = "label", pt.size = 1.5) + 
       scale_color_manual(values = paletteer_d("ggsci::default_nejm")) + 
       labs(x = "Fit-SNE 1", y = "Fit-SNE 2") + 
       theme_yehlab() + 
       theme(plot.title = element_blank()) + 
...
```{r}
p95 <- DimPlot(myo_reclust, reduction = "tsne", group.by = "label", pt.size = 1.5) + 
       scale_color_manual(values = paletteer_d("ggsci::default_nejm")) + 
       labs(x = "Fit-SNE 1", y = "Fit-SNE 2") + 
       theme_yehlab() + 
       theme(plot.title = element_blank()) + 
...
```{r}
p96 <- DimPlot(dc_reclust, reduction = "tsne", group.by = "label", pt.size = 1.5) + 
       scale_color_manual(values = paletteer_d("ggsci::default_nejm")) + 
       labs(x = "Fit-SNE 1", y = "Fit-SNE 2") + 
       theme_yehlab() + 
       theme(plot.title = element_blank()) + 
...
DimPlot(myo_norm, reduction = "tsne")
```
...
dc_norm_reclust <- ReclusterCells(myo_norm, 
                                  ...
                                  redo.embedding = TRUE, 
                                  random.seed = 629)
DimPlot(myo_norm_reclust, reduction = "bh_tsne")
FeaturePlot(myo_norm_reclust, reduction = "bh_tsne", features = "C1QA")
DimPlot(dc_norm_reclust, reduction = "tsne")
FeaturePlot(dc_norm_reclust, reduction = "tsne", features = "CLEC10A")
```
...
```{r}
p111 <- DimPlot(myo_norm_reclust, reduction = "tsne", group.by = "label", pt.size = 1.5) + 
        scale_color_manual(values = paletteer_d("ggsci::default_nejm")) + 
        labs(x = "Fit-SNE 1", y = "Fit-SNE 2") + 
        theme_yehlab() + 
        theme(plot.title = element_blank()) + 
...
```{r}
p112 <- DimPlot(dc_norm_reclust, reduction = "tsne", group.by = "label", pt.size = 1.5) + 
        scale_color_manual(values = paletteer_d("ggsci::default_nejm")) + 
        labs(x = "Fit-SNE 1", y = "Fit-SNE 2") + 
        theme_yehlab() + 
        theme(plot.title = element_blank()) + 
...
```{r}
SaveFigure(plot = p0a, name = "Seurat_Clusters_Sil_Scores")
SaveFigure(plot = p0b, name = "Seurat_Clusters_tSNE")
SaveFigure(plot = p1, name = "Seurat_Clusters_UMAP")
SaveFigure(plot = p2, name = "Seurat_Clusters_FitSNE")
SaveFigure(plot = p3, name = "SingleR_Annos_sc_ref")
SaveFigure(plot = p4, name = "SingleR_Annos_bulk_ref")
SaveFigure(plot = p5, name = "CONICSmat_Annos")
SaveFigure(plot = p6, name = "DECODER_basal")
SaveFigure(plot = p7, name = "DECODER_classical")
SaveFigure(plot = p8, name = "DECODER_exocrine")
SaveFigure(plot = p9, name = "DECODER_endocrine")
SaveFigure(plot = p10, name = "DECODER_immune")
SaveFigure(plot = p11, name = "DECODER_normal_stroma")
SaveFigure(plot = p12, name = "DECODER_act_stroma")
SaveFigure(plot = p13, name = "Fibro_all_cells_COL1A1")
SaveFigure(plot = p14, name = "Fibro_all_cells_COL3A1")
SaveFigure(plot = p15, name = "Fibro_all_cells_LUM")
SaveFigure(plot = p16, name = "Fibro_all_cells_DCN")
SaveFigure(plot = p17, name = "Fibro_SCISSORS_FitSNE")
SaveFigure(plot = p18, name = "Fibro_SCISSORS_PLVAP")
SaveFigure(plot = p19, name = "Fibro_SCISSORS_RGS5")
SaveFigure(plot = p20, name = "Fibro_apCAF_VAM")
SaveFigure(plot = p23, name = "Fibro_final_labels", pub.ready = TRUE, border = FALSE)
SaveFigure(plot = p24, name = "Endo_Perivascular_SCISSORS_FitSNE")
SaveFigure(plot = p25, name = "Perivascular_IGFBP7")
SaveFigure(plot = p26, name = "Perivascular_ACTA2")
SaveFigure(plot = p27, name = "Perivascular_RGS5")
SaveFigure(plot = p28, name = "Endothelial_PLVAP")
SaveFigure(plot = p29, name = "Endothelial_VWF")
SaveFigure(plot = p30, name = "Endo_Perivascular_final_labels", pub.ready = TRUE, border = FALSE)
SaveFigure(plot = p31, name = "NKT_all_cells_CD3D")
SaveFigure(plot = p32, name = "NKT_Tumor_SCISSORS_FitSNE")
SaveFigure(plot = p33, name = "NKT_Tumor_CD4T_IL7R")
SaveFigure(plot = p34, name = "NKT_Tumor_CD4T_CD69")
SaveFigure(plot = p35, name = "NKT_Tumor_Treg_IL2RA")
SaveFigure(plot = p36, name = "NKT_Tumor_Treg_FOXP3")
SaveFigure(plot = p37, name = "NKT_Tumor_Prolif_Treg_TOP2A")
SaveFigure(plot = p38, name = "NKT_Tumor_Mast_TPSAB1")
SaveFigure(plot = p39, name = "NKT_Tumor_NK_NKG7")
SaveFigure(plot = p40, name = "NKT_Tumor_NK_PRF1")
SaveFigure(plot = p41, name = "NKT_Tumor_CD8T_CD8A")
SaveFigure(plot = p42, name = "NKT_Tumor_CD8T_CD2")
SaveFigure(plot = p43, name = "NKT_Tumor_Intermediate_Mono_LYZ")
SaveFigure(plot = p44, name = "NKT_Tumor_Intermediate_Mono_HLADRA")
SaveFigure(plot = p45, name = "NKT_Tumor_Intermediate_Mono_CD74")
SaveFigure(plot = p46, name = "NKT_Tumor_Intermediate_Mono_HLADPB1")
SaveFigure(plot = p47, name = "NKT_Tumor_final_labels", pub.ready = TRUE, border = FALSE)
SaveFigure(plot = p48, name = "NKT_Norm_SCISSORS_FitSNE")
SaveFigure(plot = p49, name = "NKT_Norm_CD4T_IL7R")
SaveFigure(plot = p50, name = "NKT_Norm_CD4T_S100A4")
SaveFigure(plot = p51, name = "NKT_Norm_CD4T_CCR7")
SaveFigure(plot = p52, name = "NKT_Norm_CD8T_CD8A")
SaveFigure(plot = p53, name = "NKT_Norm_Treg_TIGIT")
SaveFigure(plot = p54, name = "NKT_Norm_Treg_FOXP3")
SaveFigure(plot = p55, name = "NKT_Norm_NK_PRF1")
SaveFigure(plot = p56, name = "NKT_Norm_NK_NKG7")
SaveFigure(plot = p57, name = "NKT_Norm_Prolif_Treg_TOP2A")
SaveFigure(plot = p58, name = "NKT_Norm_Intermediate_Mono_LYZ")
SaveFigure(plot = p59, name = "NKT_Norm_Intermediate_Mono_HLADRA")
SaveFigure(plot = p60, name = "NKT_Norm_Intermediate_Mono_LST1")
SaveFigure(plot = p61, name = "NKT_Norm_Intermediate_Mono_TYROBP")
SaveFigure(plot = p62, name = "NKT_Norm_SCISSORS_FitSNE", pub.ready = TRUE, border = FALSE)
SaveFigure(plot = p63, name = "Ductal_all_cells_KRT8")
SaveFigure(plot = p64, name = "Ductal_SCISSORS_FitSNE")
SaveFigure(plot = p65, name = "Ductal_Lipid_Proc_ANPEP")
SaveFigure(plot = p66, name = "Ductal_Secretory_SOD3")
SaveFigure(plot = p67, name = "Ductal_Secretory_CFTR")
SaveFigure(plot = p68, name = "Ductal_Classical1_TFF1")
SaveFigure(plot = p69, name = "Ductal_Classical1_TFF2")
SaveFigure(plot = p70, name = "Ductal_Classical1_SampleID")
SaveFigure(plot = p71, name = "Ductal_Classical2_CRISP3")
SaveFigure(plot = p72, name = "Ductal_basal_DECODER")
SaveFigure(plot = p73, name = "Ductal_CD16_Mono_CD14")
SaveFigure(plot = p74, name = "Ductal_CD16_Mono_FCGR3A")
SaveFigure(plot = p75, name = "Ductal_CD16_Mono_MS4A7")
SaveFigure(plot = p76, name = "Ductal_Acinar_CTRB2")
SaveFigure(plot = p77, name = "Ductal_final_labels", pub.ready = TRUE, border = FALSE)
SaveFigure(plot = p78, name = "Plasma_all_cells_IGJ")
SaveFigure(plot = p79, name = "Plasma_all_cells_IRF7")
SaveFigure(plot = p80, name = "Plasma_SCISSORS_FitSNE")
SaveFigure(plot = p81, name = "Plasma_Plasma_JCHAIN")
SaveFigure(plot = p82, name = "Plasma_pDC_IGJ")
SaveFigure(plot = p83, name = "Plasma_final_labels", pub.ready = TRUE, border = FALSE)
SaveFigure(plot = p84, name = "B_all_cells_MS4A1")
SaveFigure(plot = p85, name = "B_all_cells_CD79A")
SaveFigure(plot = p86, name = "B_all_cells_tissue_type")
SaveFigure(plot = p87, name = "Myeloid_Tumor_original_FitSNE")
SaveFigure(plot = p88, name = "Myeloid_Tumor_Resident_Macro_CD14")
SaveFigure(plot = p89, name = "Myeloid_Tumor_Resident_Macro_C1QA")
SaveFigure(plot = p90, name = "Myeloid_Tumor_Classic_Mono_LYZ")
SaveFigure(plot = p91, name = "Myeloid_Tumor_Classic_Mono_S100A8")
SaveFigure(plot = p92, name = "Myeloid_Tumor_Alternative_Macro_Spp1")
SaveFigure(plot = p93, name = "Myeloid_Tumor_DC_FCER1A")
SaveFigure(plot = p94, name = "Monocyte_Tumor_SCISSORS_FitSNE")
SaveFigure(plot = p95, name = "DC_Tumor_SCISSORS_FitSNE")
SaveFigure(plot = p96, name = "Monocyte_Tumor_Neutrophil_S100A8")
SaveFigure(plot = p97, name = "Monocyte_Tumor_Neutrophil_S100A9")
SaveFigure(plot = p98, name = "Monocyte_Tumor_Classic_Mono_CD14")
SaveFigure(plot = p99, name = "Monocyte_Tumor_CD16_Mono_FCGR3A")
SaveFigure(plot = p100, name = "DC_Tumor_cDC1_CLEC9A")
SaveFigure(plot = p101, name = "DC_Tumor_Langerhans_DC_CD1A")
SaveFigure(plot = p102, name = "DC_Tumor_Langerhans_DC_CD207")
SaveFigure(plot = p103, name = "DC_Tumor_Activated_DC_LAMP3")
SaveFigure(plot = p104, name = "DC_Tumor_cDC2_CLEC10A")
SaveFigure(plot = p105, name = "DC_Tumor_cDC2_KLF4")
SaveFigure(plot = p106, name = "DC_Tumor_cDC2_SAMPLEID")
SaveFigure(plot = p107, name = "Mono_Tumor_final_labels", pub.ready = TRUE, border = FALSE)
SaveFigure(plot = p108, name = "DC_Tumor_final_labels", pub.ready = TRUE, border = FALSE)
SaveFigure(plot = p109, name = "Mono_Norm_SCISSORS_FitSNE")
SaveFigure(plot = p110, name = "DC_Norm_SCISSORS_FitSNE")
SaveFigure(plot = p111, name = "Mono_Norm_Neutrophil_S100A8")
SaveFigure(plot = p112, name = "Mono_Norm_Neutrophil_S100A9")
```
