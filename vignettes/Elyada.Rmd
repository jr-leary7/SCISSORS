...
pdac_markers <- FindAllMarkers(pdac, 
                ...
                slice_head(n = 5)
p0c <- DotPlot(pdac, features = unique(pdac_markers$gene), dot.scale = 15) + 
...
p17 <- DimPlot(pdac, reduction = "tsne", cells.highlight = fibro_cells, 
               cols.highlight = "navy", pt.size = 0.75) + 
       labs(x = "Fit-SNE 1", y = "Fit-SNE 2") + 
       theme_yehlab() + 
       NoLegend()
p17 / p2
...
top5_fibro_markers <- fibro_markers2 %>% 
                      ...
                      arrange(desc(avg_log2FC)) %>% 
                      slice_head(n = 5)
p23b <- DotPlot(fibro, features = top5_fibro_markers$gene, dot.scale = 15) + 
        scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) +
...
p25 <- DimPlot(pdac, reduction = "tsne", cells.highlight = nkt_cells, 
               cols.highlight = "navy", pt.size = 0.75) + 
       labs(x = "Fit-SNE 1", y = "Fit-SNE 2") + 
       theme_yehlab() + 
       NoLegend()
...
top5_nkt_tumor_markers <- nkt_tumor_markers2 %>% 
                          ...
                          arrange(desc(avg_log2FC)) %>% 
                          slice_head(n = 5)
p40b <- DotPlot(nkt_tumor, features = unique(top5_nkt_tumor_markers$gene), dot.scale = 15) + 
        scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) +
        labs(color = "Expression", size = "% Expressed") + 
        theme(axis.text.x = element_text(angle = 90, size = 16, vjust = 0.5), 
              legend.position = "right", 
...
top5_nkt_norm_markers <- nkt_norm_markers2%>% 
                         ...
                         arrange(desc(avg_log2FC)) %>% 
                         slice_head(n = 5)
p51b <- DotPlot(nkt_norm, features = unique(top5_nkt_norm_markers$gene), dot.scale = 15) + 
        scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) +
        labs(color = "Expression", size = "% Expressed") + 
        theme(axis.text.x = element_text(angle = 90, size = 16, vjust = 0.5), 
              legend.position = "right", 
...
p53 <- DimPlot(pdac, reduction = "tsne", cells.highlight = ductal_cells, 
               cols.highlight = "navy", pt.size = 0.75) + 
       labs(x = "Fit-SNE 1", y = "Fit-SNE 2") + 
       theme_yehlab() + 
       NoLegend()
...
```{r}
p54 <- FeaturePlot(ductal, reduction = "tsne", features = "Classical PDAC") + 
       scale_color_gradientn(colors = wesanderson::wes_palette("Zissou1")) + 
       labs(x = "Fit-SNE 1", y = "Fit-SNE 2") + 
       theme_yehlab() + 
       NoLegend() + 
       theme(axis.title = element_blank())
p55 <- FeaturePlot(ductal, reduction = "tsne", features = "Basal-like PDAC") + 
       scale_color_gradientn(colors = wesanderson::wes_palette("Zissou1")) + 
       labs(x = "Fit-SNE 1", y = "Fit-SNE 2") + 
       theme_yehlab() + 
       NoLegend() + 
...
p61 <- FeaturePlot(ductal, reduction = "tsne", features = "CRISP3", pt.size = 1.5) + 
       ...
       NoLegend() + 
       theme(axis.title = element_blank())
p62 <- FeaturePlot(ductal, reduction = "tsne", features = "GATA6", pt.size = 1.5) + 
       scale_color_gradientn(colors = wesanderson::wes_palette("Zissou1")) + 
       labs(x = "Fit-SNE 1", y = "Fit-SNE 2") + 
       theme_yehlab() + 
       NoLegend() + 
...
```{r}
p62a <- FeaturePlot(ductal, reduction = "tsne", features = "basal", pt.size = 1.5) + 
        scale_color_gradientn(colors = wesanderson::wes_palette("Zissou1")) + 
        labs(x = "Fit-SNE 1", y = "Fit-SNE 2", title = "Basal") + 
        theme_yehlab() + 
        NoLegend() + 
        theme(axis.title = element_blank())
p62b <- FeaturePlot(ductal, reduction = "tsne", features = "classical", pt.size = 1.5) + 
        scale_color_gradientn(colors = wesanderson::wes_palette("Zissou1")) + 
        labs(x = "Fit-SNE 1", y = "Fit-SNE 2", title = "Classical") + 
        theme_yehlab() + 
        NoLegend() + 
        theme(axis.title = element_blank())
p62c <- FeaturePlot(ductal, reduction = "tsne", features = "bc_ratio", pt.size = 1.5) + 
        scale_color_gradientn(colors = wesanderson::wes_palette("Zissou1")) + 
        labs(x = "Fit-SNE 1", y = "Fit-SNE 2", title = "Basal:Classical") + 
        theme_yehlab() + 
        NoLegend() + 
        theme(axis.title = element_blank())
p62d <- FeaturePlot(ductal, reduction = "tsne", features = "malig", pt.size = 1.5) + 
        scale_color_manual(values = wes_palette("Zissou1", n = 5)[c(5, 2)])  + 
        labs(x = "Fit-SNE 1", y = "Fit-SNE 2", title = "Malignant") + 
        theme_yehlab() + 
        NoLegend() + 
        theme(axis.title = element_blank())
(p62a | p62b | p62c | p62d) / p53
```
...
top5_ductal_markers <- ductal_markers2 %>% 
                       ...
                       arrange(desc(avg_log2FC)) %>% 
                       slice_head(n = 5)
p64b <- DotPlot(ductal, features = unique(top5_ductal_markers$gene), dot.scale = 15) + 
        scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) +
        labs(color = "Expression", size = "% Expressed") + 
        theme(axis.text.x = element_text(angle = 90, size = 16, vjust = 0.5), 
              legend.position = "right", 
...
p70 <- DimPlot(pdac, reduction = "tsne", cells.highlight = myeloid_cells, 
               cols.highlight = "navy", pt.size = 0.75) + 
       labs(x = "Fit-SNE 1", y = "Fit-SNE 2") + 
       theme_yehlab() + 
       NoLegend()
...
top5_myo_reclust_markers <- myo_reclust_markers2 %>% 
                            ...
                            arrange(desc(avg_log2FC)) %>% 
                            slice_head(n = 5)
p95b <- DotPlot(myo_reclust, features = unique(top5_myo_reclust_markers$gene), dot.scale = 15) + 
        scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) +
        labs(color = "Expression", size = "% Expressed") + 
        theme(axis.text.x = element_text(angle = 90, size = 16, vjust = 0.5), 
              legend.position = "right", 
...
top5_dc_reclust_markers <- dc_reclust_markers2 %>% 
                           ...
                           arrange(desc(avg_log2FC)) %>% 
                           slice_head(n = 5)
p96b <- DotPlot(dc_reclust, features = unique(top5_dc_reclust_markers$gene), dot.scale = 15) + 
        scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) +
        labs(color = "Expression", size = "% Expressed") + 
        theme(axis.text.x = element_text(angle = 90, size = 16, vjust = 0.5), 
              legend.position = "right", 
...
top5_myo_norm_reclust_markers <- myo_norm_reclust_markers2 %>% 
                                 ...
                                 arrange(desc(avg_log2FC)) %>% 
                                 slice_head(n = 5)
p111b <- DotPlot(myo_norm_reclust, features = unique(top5_myo_norm_reclust_markers$gene), dot.scale = 15) + 
         scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) +
         labs(color = "Expression", size = "% Expressed") + 
         theme(axis.text.x = element_text(angle = 90, size = 16, vjust = 0.5), 
               legend.position = "right", 
...
top5_dc_norm_reclust_markers <- dc_norm_reclust_markers2 %>% 
                                ...
                                arrange(desc(avg_log2FC)) %>% 
                                slice_head(n = 5)
p112b <- DotPlot(dc_norm_reclust, features = unique(top5_dc_norm_reclust_markers$gene), dot.scale = 15) + 
         scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) +
         labs(color = "Expression", size = "% Expressed") + 
         theme(axis.text.x = element_text(angle = 90, size = 16, vjust = 0.5), 
               legend.position = "right", 
...
SaveFigure(my.plot = p0c, name = "Seurat_Clusters_Dotplot", height = 8, width = 18)
...
SaveFigure(my.plot = p23b, name = "Fibro_Dotplot", height = 8, width = 16)
...
SaveFigure(my.plot = p40b, name = "NKT_Tumor_Dotplot", height = 8, width = 18)
...
SaveFigure(my.plot = p51b, name = "NKT_Norm_Dotplot", height = 8, width = 18)
...
SaveFigure(my.plot = p62a, name = "Ductal_DECODER_Basal")
SaveFigure(my.plot = p62b, name = "Ductal_DECODER_Classical")
SaveFigure(my.plot = p62c, name = "Ductal_DECODER_BC_Ratio")
SaveFigure(my.plot = p62d, name = "Ductal_CONICSmat_Annos")
SaveFigure(my.plot = p63, name = "Ductal_Acinar_CTRB2")
SaveFigure(my.plot = p64a, name = "Ductal_Final_Labels")
SaveFigure(my.plot = p64b, name = "Ductal_Dotplot", height = 8, width = 18)
...
SaveFigure(my.plot = p95b, name = "Myeloid_Tumor_Dotplot", height = 8, width = 18)
SaveFigure(my.plot = p96a, name = "DC_Tumor_Final_Labels")
SaveFigure(my.plot = p96b, name = "DC_Tumor_Dotplot", height = 8, width = 18)
...
SaveFigure(my.plot = p111b, name = "Myeloid_Norm_Dotplot", height = 8, width = 18)
SaveFigure(my.plot = p112a, name = "DC_Norm_Final_Labels")
SaveFigure(my.plot = p112b, name = "DC_Norm_Dotplot", height = 8, width = 18)
```
