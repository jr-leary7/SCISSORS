...
top5_nkt_tumor_markers <- nkt_tumor_markers2 %>% 
                          ...
                          arrange(desc(avg_log2FC)) %>% 
                          slice_head(n = 5)
p40b <- DotPlot(nkt_tumor, features = unique(top5_nkt_tumor_markers$gene), dot.scale = 10) + 
        scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) +
        labs(color = "Expression", size = "% Expressed") + 
...
top5_nkt_norm_markers <- nkt_norm_markers2%>% 
                         ...
                         arrange(desc(avg_log2FC)) %>% 
                         slice_head(n = 5)
p51b <- DotPlot(nkt_norm, features = unique(top5_nkt_norm_markers$gene), dot.scale = 10) + 
        scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) +
        labs(color = "Expression", size = "% Expressed") + 
...
top5_ductal_markers <- ductal_markers2 %>% 
                       ...
                       arrange(desc(avg_log2FC)) %>% 
                       slice_head(n = 5)
p64b <- DotPlot(ductal, features = unique(top5_ductal_markers$gene), dot.scale = 10) + 
        scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) +
        labs(color = "Expression", size = "% Expressed") + 
...
top5_myo_reclust_markers <- myo_reclust_markers2 %>% 
                            ...
                            arrange(desc(avg_log2FC)) %>% 
                            slice_head(n = 5)
p95b <- DotPlot(myo_reclust, features = unique(top5_myo_reclust_markers$gene), dot.scale = 10) + 
        scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) +
        labs(color = "Expression", size = "% Expressed") + 
        theme(axis.text.x = element_text(angle = 90, size = 9, vjust = 0.5), 
              legend.position = "right", legend.justification = "center", 
...
top5_dc_reclust_markers <- dc_reclust_markers2 %>% 
                           ...
                           arrange(desc(avg_log2FC)) %>% 
                           slice_head(n = 5)
p96b <- DotPlot(dc_reclust, features = unique(top5_dc_reclust_markers$gene), dot.scale = 10) + 
        scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) +
        labs(color = "Expression", size = "% Expressed") + 
        theme(axis.text.x = element_text(angle = 90, size = 9, vjust = 0.5), 
              legend.position = "right", legend.justification = "center", 
...
top5_myo_norm_reclust_markers <- myo_norm_reclust_markers2 %>% 
                                 ...
                                 arrange(desc(avg_log2FC)) %>% 
                                 slice_head(n = 5)
p111b <- DotPlot(myo_norm_reclust, features = unique(top5_myo_norm_reclust_markers$gene), dot.scale = 10) + 
         scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) +
         labs(color = "Expression", size = "% Expressed") + 
         theme(axis.text.x = element_text(angle = 90, size = 12, vjust = 0.5), 
               legend.position = "right", legend.justification = "center", 
...
top5_dc_norm_reclust_markers <- dc_norm_reclust_markers2 %>% 
                                ...
                                arrange(desc(avg_log2FC)) %>% 
                                slice_head(n = 5)
p112b <- DotPlot(dc_norm_reclust, features = unique(top5_dc_norm_reclust_markers$gene), dot.scale = 10) + 
         scale_color_gradientn(colors = paletteer_d("wesanderson::Zissou1")) +
         labs(color = "Expression", size = "% Expressed") + 
